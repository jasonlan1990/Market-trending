...
const masters = [
  {
    ...
    quote: "放量修复时也要先看质量。科创和成长弹性很强，但真正能穿越波动的，仍是现金流、壁垒和估值安全同时过关的公司。",
    tags: ["放量修复", "质量优先", "安全边际"],
    picks: ["北方华创", "长江电力", "沪深300ETF"]
  },
  {
    category: "情绪流",
    ...
    quote: "155只涨停对29只跌停，情绪从冰点后明显升温。明天只做科创、半导体和AI算力前排分歧承接，后排缩量冲高不追。",
    tags: ["情绪升温", "前排核心", "分歧承接"],
    picks: ["寒武纪", "上海新阳", "信息发展"]
  },
  {
    ...
    quote: "今天龙头要看带动性：科创50大涨后，半导体材料、AI芯片和CPO能否带出梯队。不能继续扩散，就按高潮分歧处理。",
    tags: ["龙头带动", "梯队确认", "不追高潮"],
    picks: ["寒武纪", "北方华创", "有研硅"]
  },
  {
    ...
    quote: "价格已经从防守切到进攻确认。趋势交易只等核心股放量突破后的首次回踩，跌破5日线或板块退潮就退出。",
    tags: ["进攻确认", "回踩确认", "止损"],
    picks: ["北方华创", "中际旭创", "寒武纪"]
  },
  {
    ...
    quote: "科创50大涨8.41%，成长主线重新点火。真正值得追踪的是AI芯片、半导体设备、CPO这些产业兑现更清楚的核心。",
    tags: ["真成长", "业绩兑现", "科创相对强"],
    picks: ["北方华创", "寒武纪", "中际旭创"]
  },
  {
    ...
    quote: "市场转强时也不要放弃纪律。只看护城河清楚、财务质量扎实、回撤后仍有人接的成长公司。",
    tags: ["质量优先", "护城河", "少犯错"],
  ...
  },
  {
    ...
    quote: "成交额升至2.93万亿，风险偏好明显回升。组合可以提高成长仓，但仍要用宽基和红利仓平衡波动。",
    tags: ["放量", "风险偏好", "仓位"],
    picks: ["科创50ETF", "沪深300ETF", "红利ETF"]
  },
  {
    category: "量化趋势",
    icon: "fa-wave-square",
    ...
    quote: "模型今天显著加权科创硬科技、半导体材料、AI算力和创业板成长。只选涨幅、成交、资金同向的前排。",
    tags: ["强度排序", "资金同向", "前排"],
    picks: ["寒武纪", "上海新阳", "中际旭创"]
  },
  {
    ...
    avatar: "新",
    avatarStyle: "linear-gradient(135deg, #667eea, #764ba2)",
    quote: "跌停降到29只，短线容错率改善。明天只看最硬核心的分歧转一致，杂毛补涨仍然快进快出。",
    tags: ["核心审美", "分歧转强", "控制回撤"],
    picks: ["寒武纪", "有研硅", "信息发展"]
  },
  {
    ...
    quote: "强修复里龙头必须继续带队。科创、半导体、AI算力如果明天不能扩散，前排也要防高潮回落。",
    tags: ["抗跌转强", "梯队", "分歧换手"],
    picks: ["寒武纪", "北方华创", "上海新阳"]
  },
  {
    ...
    quote: "明天重点看强修复后的分歧承接：科创50能否高位稳住，涨停数能否维持百家以上，核心能否先于指数转强。",
    tags: ["强后分歧", "承接确认", "核心先行"],
    picks: ["寒武纪", "中际旭创", "北方华创"]
  },
  {
    ...
    avatar: "北",
    avatarStyle: "linear-gradient(135deg, #43e97b, #38f9d7)",
    quote: "涨停155只，打板环境改善，但高潮日更要控节奏。优先充分换手板、板块第一和低位首板。",
    tags: ["提频", "首板", "换手"],
    picks: ["低位首板", "半导体前排", "科创前排"]
  },
  {
    category: "情绪周期",
    ...
    avatar: "涅",
    avatarStyle: "linear-gradient(135deg, #ffecd2, #fcb69f)",
    quote: "今天是冰点后的强修复。接下来先看科技主线能否穿越分歧，再看补涨是否从半导体材料和软件扩散。",
    tags: ["强修复", "主线确认", "补涨扩散"],
    picks: ["寒武纪", "上海新阳", "信息发展"]
  },
  {
    ...
    quote: "进攻日也别完全放弃防守。红利、电力和银行的作用是平衡科技仓波动，不是今天的最高弹性。",
    tags: ["低估", "红利", "资源"],
  ...
  },
  {
    ...
    quote: "成长股只留质量。科创大涨是好信号，但买入仍要看订单、利润率和研发壁垒，不能只看20cm弹性。",
    tags: ["成长质量", "研发", "产业兑现"],
    picks: ["北方华创", "中际旭创", "汇川技术"]
  },
  {
    ...
    quote: "只买强于指数且均线没有破坏的股票。今天微盘仍弱，说明低质小票没有同步修复，破位股继续回避。",
    tags: ["相对强度", "二阶段", "均线"],
  ...
  },
  {
    ...
    quote: "逆向不是在大涨日追最热，而是等强主线分歧时，寻找有产业逻辑、有基本面支撑且没有破位的资产。",
    tags: ["安全边际", "逆向", "估值"],
    picks: ["沪深300ETF", "招商银行", "长江电力"]
  },
  {
    category: "产业趋势",
    icon: "fa-microchip",
    ...
    quote: "科技弹性重新爆发，市场在奖励真正的硬科技。AI芯片、半导体材料、设备和算力核心仍是重点。",
    tags: ["硬科技", "订单兑现", "回踩选强"],
    picks: ["寒武纪", "北方华创", "中际旭创"]
  }
];

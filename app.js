...
const masters = [
  {
    ...
    quote: "下跌4796家时，先看企业能不能穿越波动。今天现金流和资产质量比弹性更重要，宁愿慢一点，也不要在弱市里买脆弱故事。",
    tags: ["弱市防守", "现金流", "安全边际"],
  ...
  },
  {
    ...
    quote: "47只涨停对75只跌停，情绪已经降温。明天只看逆势核心弱转强，后排反抽和缩量冲高都先放过。",
    tags: ["情绪降温", "弱转强", "轻仓"],
    picks: ["北方华创", "中国神华", "中际旭创"]
  },
  {
    category: "龙头战法",
    icon: "fa-crown",
    ...
    quote: "普跌日里龙头不是看涨幅，而是看能否抗跌并带队修复。科创硬科技和红利核心如果不能带动板块，就继续等。",
    tags: ["抗跌龙头", "带动确认", "不抢反弹"],
    picks: ["北方华创", "寒武纪", "中国神华"]
  },
  {
    ...
    quote: "今天价格给出的信号是风险收缩。趋势交易不急着抄底，只等逆势股回踩不破，跌破关键均线就退出。",
    tags: ["趋势收缩", "回踩确认", "止损"],
    picks: ["北方华创", "中际旭创", "中国神华"]
  },
  {
    category: "成长投资",
    icon: "fa-seedling",
    ...
    quote: "科创50逆势上涨0.28%，说明成长没有全线熄火；但中证2000跌近3%，要筛掉伪成长，只留产业兑现的核心。",
    tags: ["真成长", "业绩兑现", "科创相对强"],
    picks: ["北方华创", "寒武纪", "中际旭创"]
  },
  {
    ...
    quote: "市场宽度急剧走弱时，少犯错比多赚钱更重要。只看护城河清楚、财务质量扎实、回撤后仍有人接的公司。",
    tags: ["质量优先", "护城河", "少犯错"],
  ...
  },
  {
    ...
    quote: "成交额从3.11万亿降到2.60万亿，且普跌扩散，说明风险偏好回落。组合要降波动，进攻仓只保留观察位。",
    tags: ["缩量", "波动", "仓位"],
  ...
  },
  {
    ...
    quote: "模型今天只给少数方向保留权重：科创50相对强、红利防守相对稳、小盘显著承压。只做强于指数的前排。",
    tags: ["相对强度", "风险收缩", "前排"],
    picks: ["北方华创", "中国神华", "科创50ETF"]
  },
  {
    category: "短线情绪",
    icon: "fa-bolt",
    ...
    avatar: "新",
    avatarStyle: "linear-gradient(135deg, #667eea, #764ba2)",
    quote: "跌停75只，短线容错率依然低。明天只看最硬核心能不能主动修复，低位杂毛反抽不参与。",
    tags: ["核心审美", "高低切", "控制回撤"],
    picks: ["北方华创", "寒武纪", "中际旭创"]
  },
  {
    ...
    quote: "弱市里龙头要先活下来，再谈带队。科创硬科技如果明天能从抗跌变成主动进攻，才有交易价值。",
    tags: ["抗跌转强", "梯队", "分歧换手"],
    picks: ["北方华创", "寒武纪", "中际旭创"]
  },
  {
    ...
    quote: "明天重点看普跌后的弱转强：指数低开后能否收回，上涨家数能否回到1500家以上，核心能否先于指数修复。",
    tags: ["弱转强", "修复确认", "分歧承接"],
    picks: ["北方华创", "中际旭创", "中国神华"]
  },
  {
    ...
    avatar: "北",
    avatarStyle: "linear-gradient(135deg, #43e97b, #38f9d7)",
    quote: "下跌家数接近4800家，打板要明显降频。只看低位充分换手和逆势首板，缩量秒板不适合重仓。",
    tags: ["降频", "首板", "换手"],
    picks: ["低位首板", "逆势首板", "科创前排"]
  },
  {
    category: "情绪周期",
    ...
    avatar: "涅",
    avatarStyle: "linear-gradient(135deg, #ffecd2, #fcb69f)",
    quote: "今天更像退潮后的防守日。接下来先看恐慌是否衰竭，再看新主线是否从科创或红利方向长出来。",
    tags: ["情绪退潮", "恐慌衰竭", "新主线"],
  ...
  },
  {
    ...
    quote: "弱市里不要嫌红利慢。指数缩量下跌时，煤炭、电力和银行的作用是稳住组合，而不是追求最高弹性。",
    tags: ["低估", "红利", "资源"],
    picks: ["中国神华", "长江电力", "招商银行"]
  },
  {
    ...
    quote: "成长股只留质量。科创50强于小票是好信号，但买入仍要看订单、利润率和研发壁垒，不能只看弹性。",
    tags: ["成长质量", "研发", "产业兑现"],
  ...
  },
  {
    ...
    quote: "只买强于指数且均线没有破坏的股票。今天中证2000和微盘明显走弱，破位小票必须回避。",
    tags: ["相对强度", "二阶段", "均线"],
    picks: ["北方华创", "中国神华", "长江电力"]
  },
  {
    ...
    quote: "逆向不是去接下跌飞刀，而是在恐慌里寻找有估值、有现金流、有基本面支撑的资产。",
    tags: ["安全边际", "逆向", "估值"],
  ...
  },
  {
    ...
    quote: "科技弹性没有消失，只是市场在筛选。科创50逆势收红后，真正值得看的仍是AI芯片、半导体设备和算力核心。",
    tags: ["硬科技", "订单兑现", "回踩选强"],
    picks: ["寒武纪", "北方华创", "中际旭创"]
  }
];

...
const masters = [
  {
    ...
    quote: "涨少跌多但上证50相对抗跌，说明资金在找确定性。优先现金流、分红和估值安全，不碰只靠情绪的小票。",
    tags: ["收盘样本", "现金流", "防守"],
  ...
  },
  {
    ...
    quote: "101只涨停对99只跌停，情绪是割裂的。只做氨纶、燃料电池、煤炭这类最强方向的核心换手，后排冲高不追。",
    tags: ["情绪割裂", "核心换手", "去后排"],
    picks: ["华峰化学", "亿华通-U", "昊华能源"]
  },
  {
    category: "龙头战法",
    icon: "fa-crown",
    ...
    quote: "题材不是普涨，龙头必须能带板块。氨纶、燃料电池如果次日不能扩散，就按短线套利处理。",
    tags: ["龙头带动", "换手确认", "不追缩量"],
    picks: ["华峰化学", "亿华通-U", "巨星农牧"]
  },
  {
    category: "趋势交易",
    icon: "fa-chart-line",
    ...
    quote: "价格已经给出线索：化工、燃料电池、煤炭强于指数。交易只等突破后的回踩不破，失守趋势线立即退出。",
    tags: ["趋势跟随", "回踩确认", "止损"],
    picks: ["华峰化学", "东方盛虹", "昊华能源"]
  },
  {
    category: "成长投资",
    icon: "fa-seedling",
    ...
    quote: "科创50上涨说明成长没有熄火，但中证2000和微盘走弱，要筛掉伪成长，只留产业兑现和业绩能跟上的公司。",
    tags: ["真成长", "业绩兑现", "科创相对强"],
    picks: ["北方华创", "寒武纪", "中际旭创"]
  },
  {
    ...
    quote: "市场宽度走弱时，宁可买可理解的优质公司，不买需要连续情绪接力的故事。强趋势也要有护城河支撑。",
    tags: ["质量优先", "护城河", "少犯错"],
    picks: ["宁德时代", "汇川技术", "迈瑞医疗"]
  },
  {
    category: "宏观配置",
    icon: "fa-globe",
    ...
    quote: "成交放大但涨跌两端都极端，说明波动正在上升。组合一半防守，一半观察弹性，别把仓位押在单一风格上。",
    tags: ["赔率", "波动", "仓位"],
  ...
  },
  {
    ...
    quote: "强度排序显示氨纶、燃料电池、生猪和煤炭领先。只选涨幅、成交、资金同向的前排，不做主观补涨。",
    tags: ["强度排序", "资金同向", "前排"],
    picks: ["华峰化学", "亿华通-U", "巨星农牧"]
  },
  {
    ...
    avatar: "新",
    avatarStyle: "linear-gradient(135deg, #667eea, #764ba2)",
    quote: "跌停99只，容错率很低。短线只看最硬核心，分歧后仍能主动走强才值得出手，补涨幻想要少一点。",
    tags: ["核心审美", "高低切", "控制回撤"],
    picks: ["华峰化学", "亿华通-U", "兰花科创"]
  },
  {
    category: "龙头战法",
    icon: "fa-crown",
    ...
    quote: "龙头要带出梯队。氨纶、燃料电池若明天只有单点冲高，没有中军和后排跟随，就不能当主升看。",
    tags: ["带动性", "梯队", "分歧换手"],
    picks: ["华峰化学", "亿华通-U", "东方盛虹"]
  },
  {
    category: "弱转强",
    icon: "fa-rotate",
    ...
    quote: "明天重点看今日强板块分歧后能否弱转强，尤其燃料电池、化工和钴方向是否继续超预期。",
    tags: ["弱转强", "超预期", "分歧承接"],
    picks: ["亿华通-U", "华峰化学", "寒锐钴业"]
  },
  {
    category: "打板高频",
    icon: "fa-fire",
    ...
    avatar: "北",
    avatarStyle: "linear-gradient(135deg, #43e97b, #38f9d7)",
    quote: "炸板率不低且跌停多，打板要降频。优先低位首板和充分换手板，缩量秒板只适合观察不适合重仓。",
    tags: ["降频", "首板", "换手"],
    picks: ["低位首板", "换手板", "氨纶前排"]
  },
  {
    ...
    avatar: "涅",
    avatarStyle: "linear-gradient(135deg, #ffecd2, #fcb69f)",
    quote: "这不是全面修复，而是分歧市里的局部抱团。接下来要看连板高度能否继续打开，以及核心断板后的反馈。",
    tags: ["情绪周期", "局部抱团", "高度"],
    picks: ["华峰化学", "巨星农牧", "昊华能源"]
  },
  {
    category: "价值防守",
    ...
    quote: "煤炭和高股息重新占优，说明资金在找现金流和确定性。资源股不能追太急，但回调到估值合理区可配置。",
    tags: ["低估", "红利", "资源"],
    picks: ["中国神华", "昊华能源", "长江电力"]
  },
  {
    category: "成长质量",
    icon: "fa-medal",
    ...
    quote: "成长股要回到产业兑现。科创50强于小票，但不能无差别追；研发壁垒、订单和利润率才是筛选标准。",
    tags: ["成长质量", "研发", "产业兑现"],
    picks: ["北方华创", "汇川技术", "中际旭创"]
  },
  {
    category: "价格行为",
    ...
    quote: "只买二阶段上升且强于指数的股票。中证2000和微盘走弱时，破位小票必须回避。",
    tags: ["相对强度", "二阶段", "均线"],
    picks: ["华峰化学", "亿华通-U", "东方盛虹"]
  },
  {
    ...
    quote: "当市场追逐化工和煤炭时，逆向不是去买弱股，而是看估值和现金流，避免高位情绪溢价。",
    tags: ["安全边际", "逆向", "估值"],
    picks: ["中国神华", "招商银行", "沪深300ETF"]
  },
  {
    category: "产业趋势",
    icon: "fa-microchip",
    ...
    quote: "燃料电池上涨说明资金愿意试新产业，但必须看政策催化和订单兑现。科技弹性股只适合在回踩中选强。",
    tags: ["新能源技术", "政策催化", "订单"],
    picks: ["亿华通-U", "美锦能源", "北方华创"]
  }
];

...
const masters = [
  {
    ...
    quote: "下跌3790家时，市场还谈不上全面修复。先看企业能不能穿越波动，现金流、资产质量和估值安全仍比弹性重要。",
    tags: ["弱市防守", "现金流", "安全边际"],
  ...
  },
  {
    ...
    quote: "83只涨停对98只跌停，情绪有修复但还没反转。明天只看前排核心弱转强，后排反抽和缩量冲高都先放过。",
    tags: ["弱修复", "弱转强", "轻仓"],
    picks: ["北方华创", "寒武纪", "视觉中国"]
  },
  {
    ...
    quote: "今天龙头要看带动性：科创硬科技能否继续强于指数，油服和软件前排能否带出梯队。不能带队就继续等。",
    tags: ["抗跌龙头", "带动确认", "不抢反弹"],
    picks: ["北方华创", "寒武纪", "海油工程"]
  },
  {
    ...
    quote: "价格给出的信号是局部弱修复。趋势交易不急着扩大仓位，只等逆势股回踩不破，跌破关键均线就退出。",
    tags: ["局部修复", "回踩确认", "止损"],
    picks: ["北方华创", "中际旭创", "中国海油"]
  },
  {
    category: "成长投资",
    icon: "fa-seedling",
    ...
    quote: "科创50连续逆势，今天上涨0.73%，说明成长没有全线熄火；但中证2000继续下跌，要筛掉伪成长。",
    tags: ["真成长", "业绩兑现", "科创相对强"],
    picks: ["北方华创", "寒武纪", "中际旭创"]
  },
  {
    ...
    quote: "宽度有所修复但仍偏弱，少犯错比多赚钱更重要。只看护城河清楚、财务质量扎实、回撤后仍有人接的公司。",
    tags: ["质量优先", "护城河", "少犯错"],
    picks: ["长江电力", "汇川技术", "迈瑞医疗"]
  },
  {
    category: "宏观配置",
    icon: "fa-globe",
    ...
    quote: "成交额约2.58万亿，较昨日小幅缩量，风险偏好还没全面回升。组合要降波动，进攻仓只保留观察位。",
    tags: ["缩量", "波动", "仓位"],
  ...
  },
  {
    ...
    quote: "模型今天只给少数方向保留权重：科创50相对强、油服和软件有局部强度，小盘仍承压。只做强于指数的前排。",
    tags: ["相对强度", "风险收缩", "前排"],
    picks: ["北方华创", "海油工程", "科创50ETF"]
  },
  {
    category: "短线情绪",
    icon: "fa-bolt",
    ...
    avatar: "新",
    avatarStyle: "linear-gradient(135deg, #667eea, #764ba2)",
    quote: "跌停98只，短线容错率依然低。明天只看最硬核心能不能主动修复，低位杂毛反抽不参与。",
    tags: ["核心审美", "高低切", "控制回撤"],
    picks: ["北方华创", "寒武纪", "中际旭创"]
  },
  {
    ...
    quote: "弱修复里龙头要能带队。科创、油服、软件如果明天能从抗跌变成主动进攻，才有交易价值。",
    tags: ["抗跌转强", "梯队", "分歧换手"],
    picks: ["北方华创", "海油工程", "视觉中国"]
  },
  {
    category: "弱转强",
    icon: "fa-rotate",
    ...
    quote: "明天重点看弱修复能否延续：上涨家数能否站上2000家，跌停数能否明显下降，核心能否先于指数修复。",
    tags: ["弱转强", "修复确认", "分歧承接"],
    picks: ["北方华创", "寒武纪", "海油工程"]
  },
  {
    ...
    avatar: "北",
    avatarStyle: "linear-gradient(135deg, #43e97b, #38f9d7)",
    quote: "下跌家数仍有3790家，打板继续降频。只看低位充分换手、板块第一和逆势首板，缩量秒板不适合重仓。",
    tags: ["降频", "首板", "换手"],
    picks: ["低位首板", "油服前排", "科创前排"]
  },
  {
    category: "情绪周期",
    ...
    avatar: "涅",
    avatarStyle: "linear-gradient(135deg, #ffecd2, #fcb69f)",
    quote: "今天是退潮后的弱修复。接下来先看跌停是否收敛，再看新主线是否从科创、油服或软件方向长出来。",
    tags: ["弱修复", "跌停收敛", "新主线"],
    picks: ["北方华创", "海油工程", "恒生电子"]
  },
  {
    category: "价值防守",
    ...
    quote: "弱市里不要嫌红利慢。上证50接近平盘时，煤炭、电力和银行的作用是稳住组合，而不是追求最高弹性。",
    tags: ["低估", "红利", "资源"],
    picks: ["中国神华", "长江电力", "招商银行"]
  },
  {
    ...
    quote: "成长股只留质量。科创50连续强于小票是好信号，但买入仍要看订单、利润率和研发壁垒，不能只看弹性。",
    tags: ["成长质量", "研发", "产业兑现"],
    picks: ["北方华创", "中际旭创", "汇川技术"]
  },
  {
    category: "价格行为",
    ...
    quote: "只买强于指数且均线没有破坏的股票。今天中证2000和微盘代理仍明显走弱，破位小票必须回避。",
    tags: ["相对强度", "二阶段", "均线"],
    picks: ["北方华创", "中国神华", "长江电力"]
  },
  {
    category: "逆向投资",
    ...
    quote: "逆向不是去接下跌飞刀，而是在分化里寻找有估值、有现金流、有基本面支撑且没有破位的资产。",
    tags: ["安全边际", "逆向", "估值"],
  ...
  },
  {
    ...
    quote: "科技弹性没有消失，只是市场在筛选。科创50继续逆势后，真正值得看的仍是AI芯片、半导体设备和算力核心。",
    tags: ["硬科技", "订单兑现", "回踩选强"],
    picks: ["寒武纪", "北方华创", "中际旭创"]
  }
];
